...
@interface plumberFMDatabaseQueue : NSObject {
    NSString            *_path;
    dispatch_queue_t    _queue;
    plumberFMDatabase          *_db;
    int                 _openFlags;
    NSString            *_vfsName;
}
...
// If you need to nest, use plumberFMDatabase's startSavePointWithName:error: instead.
