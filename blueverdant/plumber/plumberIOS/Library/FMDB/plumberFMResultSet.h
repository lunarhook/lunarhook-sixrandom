...
@interface plumberFMResultSet : NSObject {
    plumberFMDatabase          *_parentDB;
    plumberFMStatement         *_statement;
...
@property (atomic, retain) plumberFMStatement *statement;
