...
var story1Module = new Array()
story1Module[0] = {
    "index": "亲密三部曲",
    "name": "写在开始",
    "content": [
        "今年有三篇重要的个人文档要写，要完成亲密关系/心理教育/原生家庭的三部曲",
        " ",
        "第一篇是写关系，目的是解释为什么亲密关系会出这么多问题，因为在关系中需求得不到解决自然 痛苦的，亲密关系的本质还是要解决(安全等核心方面的)需求。解决问题通常有两种，教会别人 来服务你，这依赖于的耐心和控制力，以及对方的学习能力和付出;另一种方式更简单，降低自己 的需求标准或者转移需求，这也相当于需求被比较初级的满足了(比如⻝物和水以及性需求等)。 之所以用关系来做标题，是因为你要想好，是教会来服务你，还是干脆降低或者转移自己的需求， 甚至就没有亲密关系需求了(当然下文中用核心原则一可以推翻:人的安全需求需要外部他人来保 证，所以你的安全需求还需要法律层面的亲密关系保证，例如婚姻，除非法律无比健全你也不需要 什么别人的关心和沟通需求)",
        " ",
        "第二篇是写心理教育问题，人在发现和解决问题都需要能力，一种是探索能力用于发现问题，这依 赖于人的感官能力以及环境和经历过往;另一种是把探索到的的感觉内容整理成逻辑的逻辑思考能 力;这两个能力的组合可以说是学习能力(现代人是比较缺乏前一种能力的)。之所以写成心理问 题是因为在学习的过程中要建立强大的心理素质，在整个过程中要想办法控制自己，因为探索和思 考中会受到无数艰难的阻碍影响，如何排除影响，是要靠自己来解决的，这就是难的含义。所谓控 制就是让外部对自己的影响小。因为作为渺小的人类面对泰山崩于前而面不改色就是这样一种可怕 的能力，强大的心理和强大的逻辑，拥有生死都不能改变的意志，自然强大的。 ",
        "在教育本身以外，还需要解决问题的能力，即对矛盾的控制能力(矛盾是问题的根据原因，没有矛 盾就没有问题了，通常矛盾的主要方面都是具有很强主动性的)，这点除了上述说的学习能力，还需要对关系或者事情的掌控能力，礼记:大同篇的:’大道之行也，天下为公， 选贤与能，讲信修 睦。’所以解决问题，一方面是才能，有控制问题的能力，另一方面，就是要选择信任的人。",
        " ",
        "第三篇是写家庭问题，通常来说通过第二篇的人都是强大无比的，但是再强大，你的原生家庭对你的影响你是永远无法消除的，甚至无法改变。这一层，你就需要更强大的心理素质，强大的探索和学习能力，才能驾驭的，因为总会遇到无法改变和无法掌控的事。当你新建立的家庭，多或者少都有来自原生家庭的部分，可能是好也可能是不好的，而决定哪些部分进入你的家庭并不是你能选择的，而是你的认识，习惯(本质是效率和成本，也就是控制矛盾的那些基本条件决定的)，这是你家庭原生的基本动力，所以当你的认识不够本质，解决问题不够强大的时候，你别无选择，就好比你无法选择你的出身一样，你生而为人，而不是神，还是个普普通通人。而对于原生家庭条件不够好的人来说，建立新的家庭是改善自己状态的更好办法，但是如果没有建立新的亲密关系，就还是依赖着原生家庭的本质而延续",
...
story1Module[1] = {
    ...
    "content": [
        "　　",
        "   三部曲是之所以是这样的顺序，是要探索每个人的行为循环的形成，亲密关系在这个探索循环中如果加速循环过程则人的需求满足会变快，亲密关系幸福，否则变慢，变得不幸。(但是它不会像教育和原生家庭一样对你产生改变或者让你知道哪些是无法改变的，整体来说是最浅层面的改善)",
        " ",
        "   如果一个人的需求不能合理管理，加上亲密关系对循环过程的改变，就会导致亲密关系的各种问题，因为亲密关系本身不能带来任何利益的改变(你可以拿走对方的，但是你俩人总和不变)，所以亲密关系的本质是消耗资源加强(安全或者其他核心的)需求满足，至于消耗是谁的，会决定这个过程的本质",
        " ",
        "   所以亲密关系思想的核心会变成两点，如果我的安全可以自给自足，那我并不需要亲密关系，所以核心原则一:",
        "",
        "   亲密关系需要消耗对方的资源来满足你在亲密关系中的(安全)需求，其中安全需求都必须别人来给予。(否则要什么法院和社会制度以及婚姻，这个问题就不在累述，之所以选择安全来表达最基本的需求就是因为安全需要外部提供)",
        "   即:消耗对方的资源来满足我的(安全或者其他核心的)需求(1、关系中对方的姿态不高于我， 2、我的需求合理所以需求必须完全满足)",
        "",
        "   所谓安全是一种状态，所以状态需要保持，对需求持续满足，所以核心原则二:亲密关系需要对方不断的消耗资源来满足你在亲密关系中变化的安全需求，变化的部分都是增加消耗，所以亲密关系是持续扩大的消耗，所以过程中你必须帮扶对方成⻓变强来满足自己的扩大消耗，否则就必须放弃对方，教育不断成⻓满足需求或者离开终结过程，是永恒的话题",
        "   即:教育或沟通让对方满足自己的(安全，甚至额外的、掠夺性的)需求(姿态不能高于我)",
        "",
        "   对于学习能力强，沟通能力好的人，解决这个问题成本相对低难度也小，当然碰到对方任性管理不了需求的情况也无法解决。此外有些需求是⻓期的，所以中途供给总会出现一些变化。",
        "",
        "对于需求满足不了的，也可以通过另一种负形态解决，就是掠夺性满足，而且通常是彼此掠夺，不会存在单方面的，否者这种需求不对称的模型，在各自的需求范围内必须满足本篇所说的核心一，都站着或者单姿态很低是不存在的，让对方来满足自己的需求本质还是不变的。",
        "",
        "可以理解成良人和良人生活，因为达成需求满足的条件差不多;恶人就只能和恶人生活，都是通过暴力解决的，因为平衡;需求和解决需求的模型都还是相似的，而且这样彼此的成本都低，沟通更简单，也就是说人得找相似生活模型的，但是功能上必须互补",
        "",
        "很多自我行动暴力的，非要找个良人模型的，纯粹和自己过意不去，也和对方过意不去的，很难维持⻓久的，因为模型的循环成本对彼此都高，甚至有伤害性(包括身体的，精神的伤害)" ,
        "",
        "使用数据统计/大数据的方式来探索和确认这个很有效，可以⻓期观察人的思考决策和行为路径，可 以知道是否是刻意避开所有的不合理的路线(存在伤害或者掠夺的路线)来满足自己的需求，因为 回避某些路线会让自己的实现成本变高，也不符合最大利益原则(利益最大原则不适合两人以上关 系，因为拿走对方的所有才是利益最大，存在伤害性)即:亲密关系内个体最大利益模型循环，必 然是存在伤害性的",
        "",
        "伤害性(很多人是可以接受这个状态的，因为原生家庭也如此)或者可以理解成，给予安全的同时也在破坏安全，随着亲密关系内状态的改变，这种模型很容易改变，因为实现能力和需求都在大幅度变化，生产力和经济环境的不稳定导致冲击很明显",
    ],
}

story1Module[2] = {
    "index": "亲密三部曲",
    "name": "亲密关系副篇:为什么婚姻关系需要法律保护",
    "content": [
        "   首先我们需要说明关系就只有两种，两人之间的私人关系，三人及三人以上的公开关系",
        "   私人关系最大的问题就是缺少监督，所以不足够安全，完全需要信任，所以很多的双方交易都需要合同，但是涉及到大宗交易，就必须引入第三方来做背书，从两者变成三者从而进入公开关系。",
        "　　但是婚姻关系是无法引入第三者的，即便有小孩成为家庭成员也不够保证，所以必须使用法律来保证两人的关系能进入公开合法性。",
        "   之所以很多婚外恋是处于隐蔽状态，因为这种行为会伤害到自己的原生家庭。至少在亲密关系中伤 害对方，这种伤害导致的就是信任全部，亲密关系冷漠，一方对家庭的伤害很容易导致离异。",
        "   我们可以比较容易的推到出婚外恋的主导者就是在关系内需求没有满足的人，当然，存在不合理需 求，也存在合理需求两种情况，前者必然破坏家庭，后者还有机会通过教育/沟通改善。",
        "   由于是需求的满足问题，在合理的情况下出轨的原因是考察另一方。而不合理的需求就需要考察出 轨的主动方。",
        "   但是，不论如何，需求不满足，必然是外部寻求需求解决的。走到这条路线上，是肯定要通过破坏 婚姻，寻求法律途径解决的，是一条伤害对方的途径。",
        "   究其根本就是因为社会提供了太多基础保护，让人缺少了对过错的内疚，扩大了自己需求优先满 足，对对方安全需求的降低使得婚姻难以维持，都没有安全需求了，为什么要为对方的安全考虑? 有保险，有房子住，有饭吃，自己就只需要寻找自己的幸福就好了，所以婚姻缺少了责任，伤害对 方说个对不起就完了，所以欺骗的代价也变得小，我们会在下一篇的额外篇讲述如何培养责任心。",
    ]
}
...
story1Module[3] = {
    ...
    "content": [
        ...
        "   先给结论，核心原则三:掌控要看能否完全掌控自己，找到并坚持自己的方向(建立自己的信仰)，理性的，带有逻辑的热情和确定",
        "   即:如何让环境对自己影响变小(强大心理，影响小归小，但不可能消除)让自己能控制自己",
        "　　很多时候鼓励自己是在自己的道路上探索，如果你赢得自己掌控，回报一定是超过你的投入，掌控自己就是要在自己的方向上建立别人不可代替的、独立的，信仰的，这就需要心理上的自信，这就是需要培养自己的自信，而形成这些心理状态的，都是自己和外向交互，探索，学习，养成的。",
        "   当然很多时候可能是家庭，环境塑造的(后面我们会说原生家庭的对人的改变问题)，但是最终能自己掌握的，必然是自己在主动的探索，掌控，所有的创造，都是在自己主动，独立，探索的基础上完成的。",
        "　　后来在记录方法中调整消除了长夏，并将长夏分成四份，分别放入其它的季节之末补足",
        "   人的五官感知都是感性器官，没有逻辑，但是人的大脑是有思考的逻辑器官，有逻辑判断能力，所以自控力的影响是通过感性器官进入人的内部，再由大脑的思维做出决定的，那么感知能否进入大脑和大脑能否形成合理的逻辑就成为这件事的两个􏰀要主题，逻辑可以反复验证，通过社会教育，家庭，学校都可以比较通性的完成，那么感知呢?",
        "　　还是先给结论:核心原则四:感知力即探索能力，探索速度决定了信息交换的结果，这包括交换效率和数据量(香农公式)",
        "   即:如何快速主动有效率的发现问题(发现问题最怕晚)并控制、解决问题",
        "　　通常来说学习好的人一般逻辑能力比较强，这很常⻅，但是在通识领域外学习还很好的，都是探索能力强的，因为可以很快的发现问题，然后想办法解决问题(控制问题即控制矛盾)，学习不好的，都是问题摆在面前都解决不了，更别说探索了",
        "   人、衰老的开始，就是对探索不在敏感",
        "　　而丑未辰戌我们成为四隅，卯、午、酉、子我们称为四正，也就是以后的四桃花，可以见图",
        "   如果五官都不能正常的感受变化了，可以想象而知了。",
        "　　所以地支也可以和方向结合，子表示北方，午表示南方，卯表示东方，酉表示西方",
        "   总结来说，人的心理决定了很多问题，这包括在感受部分的探索和逻辑部分的决策，逻辑的部分的训练成本相对来说还容易实现一些，但是失去了探索能力，相当于不会发现问题。回到第一篇的亲密关系问题场景中，它就很难发现亲密关系中变化的需求和不平衡的出现，因为压根就没有感知能力，就更不要说解决亲密关系的问题",
        "　　都说沟通很􏰀要，是很􏰀要，因为沟通可以解决很多探索方面的问题，因为可以问。但是非人类社会的问题，比如自然界的问题，就必须依靠探索了，沟通只能解决一小部分问题。所以需要通过教育学习，改善逻辑，训练自己的五官能力去强化探索，对应该有的问题保持好奇，才能更多的发现问题，解决问题，掌控更多的问题，控制矛盾，从而控制好自己以及在外部不确定的环境下，如果通过自己的能力影响自己一样。",
        "   对于那些不能强化学习，强化探索的人，世界上不能对自己的行为做决策的人很多，至于有强大探索能力的人就更少，所以很多事不是自己能决定的，这很合理，也很正常，发现无力改变的，但是只要管理好自己合理的需求就可以。",
        "　　对于那些有能力掌控自己的人，要控制自己的人，我们还需要谈谈你无论如何都要接受而不能改变的事，也是对你影响终身的事，你的原生家庭。因为哪怕是一个人自己过，未来你要考虑当得起一个家，要扛得起家，至少要扛得住自己一个人。",
    ]
}
story1Module[4] = {
    "index": "亲密三部曲",
    "name": "心里教育副篇:控制力",
    "content": [
        "　　本篇主要讲的对人的基本判断需要有三点:责任心，勤劳，诚实",
        "   主动是责任心最好的阐述，因为发现问题都是主动的，被动的都是被问题推着走的，学习也是中东的，责任心也是主动的",
        "　　解决问题需要行动，在最初谁都不知道如何解决，都是尝试的过程，那些尝试多的人在执行上效率更高，但是这需要勤劳的训练，多次的尝试，不断探索和思考的结合",
        "   人类世界除了对物质的控制，还有对人的控制，也就是关系，诚实是让别人愿意靠近你，共同分享问题和结果的方式，诚实会让人信任，对人的需求和未来可以期待和判断，在很多劳动中，因为考虑协作性问题，诚实也是必要的，包括彼此信任和利益的合理分配",
        "　　对于不喜欢劳动的人，那么很多问题的在主动性上往往不能走通，所以对满足自己需求的过程中，都需要别人来满足自己，要不通过暴力的压迫，要不通过欺骗，因为就不能通过自己来满足。",
        "   所以既不主动发现问题，也不肯主动解决问题的人，都是会花心思，假以他人来完成需求，这种条件下，只有利用关系，无法缔结⻓期关系，更无法亲密，甚至可以使用欺骗的方式。所以培养自己的主动性，最好的方式就是从劳动开始。",
        "   有些人看似勤奋，只是之前的训练导致，只有真正通过探索总结形成规律的自律和勤劳才能真正的培养责任心",
        "   教育的本质，就是让人有控制力:有情绪控制力，有判断是否的控制力，有抵抗外界环境的控制力，有自制的控制力等等，让人独立",
        "　　大家共同应该遵守的控制力，即社会道德，我们会在第三篇的额外篇继续介绍",
    ]
}

story1Module[5] = {
    "index": "亲密三部曲",
    "name": "第三篇 原生家庭-你永远无法掌控和改变的过去",
    "content": [
        "   其实只有很少的人需要对原生家庭做出深刻的理解，大部分都不需要考虑这个层面的问题，因为永远无法掌控，只能接受",
        "   习惯性的先给结论:核心原则五:人的成⻓依赖于一个你无法掌控的环境，唯一的出路是走出原生家庭，建立自己可以掌控的家庭",
        "   你的出生，从一个婴儿状态的过程是你无法掌控的。所以你一路走来，都是一个你熟悉的家庭带给你的，不论好是如何好，坏是什么坏，你都没有选择，你都需要与这个家庭伴生，对抗，自己不断成⻓。就算你永远待在这个家，最后也只能孤单的一个人，所以你要面对的问题是要不要走出去，所以你的很多需求，负责原则一，需要别人提供，你所需要做的，需要负责原则三，让自己独立⻓空自己。",
        "   对于很多人来说，一辈子都走不出自己的原生家庭，因为很多人没有能力探索并意识到问题，完全凭借自己的感受在处理家庭的问题，也就是所谓的嬉笑怒骂，中国人的⻣子里对家庭其实是叛逆的，哪怕所谓的世家，而这种叛逆在真正理解自己的责任以后，就会消失，这就是所谓的中国人都被他们当中那一小撮最强悍的人保护的很好的说法，这类人确实存在，确实可以主宰社会，毕竟王侯将相宁有种乎",
        "   虽然很多人的家庭看着很好，但是子女却走向的平庸。这是因为人的一生要经历很多事才能变得强大，当一个家庭不能带给你足够的问题视􏰂时候，你就无法成⻓，或者说你需要走出原生家庭才能成⻓，才能真正的面对社会，人才能变得象动物一样敏感，处理问题才会变得更加成熟。对于原则三，如果没有碰到适合的环境，甚至原则一提供了足够的需求满足，都不会加速成⻓，所以逆境是成⻓必须的条件之一",
        "   核心原则六:不关注自己安全的需求的人，是不会关注别人安全需求的，特别的，如果这类人还会去探索亲密关系的话，不去独立掌握问题的话，必然是关系内追求利益的，必然是不幸的。",
        "　　我们有很多的文字还在用繁体字的时候，会明显的有文字的原始含义，比如“學習”的學字，学的繁体字上半部分是一个手把手的教户动作，内部是一个爻字，下半部分是个宝盖里面一个子，它的基本含义就是手把手的在房子里教你去探索感受问题",
        "   这就是一个基本模式的循环，因为这类人往往在自己的原生家庭就没有得到安全，或者就是在处于婚内掠夺的状态，对伤害司空⻅惯，认为只有财富利益是安全的。这就又回到的核心原则一，它是永远没有安全的",
        "　　在比如师傅的师字，以及帅字，都是有立干见影的含义，师是可以按规定测量太阳的人，表示出师。而帅字则是表示能掌握立杆的人，后来表示权利",
        "   最终，家庭其实只能给你带来安全，但是世界是多样的，不确定的，不足够安全的，所以人需要在 家庭和客观世界中不断碰到问题和选择，解决问题的过程就是控制问题的过程，就是获得安全/利益 的过程，也是探索/独立的过程。",
        "　　师也是周易的一卦，表示战争。所以卦除了卦象，还有名字的本意，需要结合的理解",
        "   很多人为了家庭所做出的牺牲，很少是自己意识到的，绝大部分都是不得不这么做的。而没有付出的，都是不需要家庭来满足需求的，这种对自己安全都不关注的人，是不会关注别人的安全的。特别的，如果他还抱着目的去选择亲密关系的话，只能是寻求利益的，是必然带来伤害的，会形成一个新的可悲的原生家庭",
        "　　所以当一个人对安全没有需求，而又选择亲密关系的时候，很多恶意和悲哀是注定的，这是原生家庭的根本问题:没有认识的亲密关系的价值在于安全，而又强制让对方满足自己各方面的需求，使得亲密关系存在不同程度的伤害性",]
}
story1Module[6] = {
    "index": "亲密三部曲",
    "name": "原生家庭副篇:道德和人品",
    "content": [
        "   所谓道德是社会中不受法律规定但是应该公开遵守的规则，最简单的问题，比如不伤害别人的情感，不欺骗对方的情感，履约，等等，用一句话总结，讲信修睦,只是道德限定在人与人的个体之间",
        "   所谓人品，就是一个人自己的行为方式，一个人习惯如此是因为这么做成本低或者他的标准这样是成本最低的效率最适合的，之所以说是人品，因为根据同理心，他如何对待自己就因该如何对待比尔呢，也就是说一个人的人品就可以映射了他认为社会中应该有的道德。",
        "   一个不懂得说对不起的人，就已经不用考虑道德层面的约束问题了。",
        "   所以说一个人的品质如果不能变的更好，那就是这样了，在家庭中，品质之间的冲突才是最基本的冲突，而非三观。因为品质决定了我能提供付出的价值以及我需要的价值，一个贪婪的人，必然付出少于得到，自私也是如此。",
        "   所以一个原生家庭每个人的品质决定了原生家庭的本质，以及是否满足家庭成员每个人的需求。当安全供给不足的时候，只能依靠法律保证基本安全和财产。这显然是远远不够的，至少不能满足基本的情感和沟通需求，但是环境中也非常难以改变",
        "   人品在人的一生中形成固化以后就很难改变，习惯难以调整",
        "   这就导致了你原生家庭的某些形成的原因，所以早期的视􏰂和教育，教育的程度，以及是否懂得别人的需求及核心安全需求，理解基础的人品和道德，构成了一个原生家庭最基本的环境。",
        "   你婚姻的选择往往是选择另外一个家庭的道德和人品，并非三观一致的问题，三观一致彼此伤害的家庭走不到最终，这是每个人的必修课",
        ]
}

story1Module[7] = {
    "index": "亲密三部曲",
    "name": "总结:关系不是东⻛压倒⻄⻛就是⻄⻛压倒东⻛",
    "content": [
        "大到宇宙，小到原子，所有的关系都趋于被很好的管理着",
        "宇宙、自然、地球、人类社会皆如此，都是被管理着，所以老子说老死不相往来才能避免这种一边高高在上一边默默低头的关系。",
        "人的所有关系的基本就只有一种，关系中被管理和管理的，不论多复杂的关系，从个体⻆度看，必然有一个唯一的，最大的最直接的管理者，由他们之间形成了所有的基本链条",
        "亲密关系中也是如此，为了获得自己最需要的需求，自己是需要默默低头的，这种需求往往是安全，至少在亲密关系中是这样，就是需要对方来关注自己。也是需要一方低头服务，另一方来对服务做反馈，所以不断的􏰀复这个过程，不断的调整服务和反馈过程就变得􏰀要，如果亲密关系中的这种服务和反馈不能持续，服务不到位，反馈不及时都会出问题，都会影响彼此需求的满意程度，一直到无法满足的时候，这种关系就出现问题，亲密关系就终止了。",
        "所以在基本的核心需求上，必须给出及时的反馈，这种安全的供需关系是维持婚姻的基石。",
        "但是不论如何供给，关系的强弱方是由需求的程度来决定的，需求更强的一方需要降低自己在关系中的位置，因为这种需求交换的代替性决定了自己是可以位置阶层高一些，还是低一些。这是在不断调整的供需关系中转换而来的。",
        "由于核心关系的不变性，⻓期性，供给的满足性，就决定了这种关系的稳固，这就是婚姻关系的本质性，它在关系存在的过程中，⻓期不会改变，在稳定的原生家庭中也不可改变。",
...
story1Module[8] = {
    ...
    "name": "结尾:",
    "content": [
        "1、人的安全在不断的通过国家福利取代了婚姻，所以对婚姻的安全需求越来越小，代替的都是个人 利益和个人发展，使得人更多关注自己，越来越自私。但自私是可以通过教育的行为改善",
        "2、教育使得人更懂得如何控制外界以及对自己的控制越来越明确，好的控制力在避免自私的时候 (有责任心)，自律可以使得人勤奋或者勤劳，对品德的自律和责任使得人诚实。这些好的控制约 束在追逐自己的需求的时候能控制自己不伤害人(诚实而有责任)只通过自己创造来完成(勤劳而 有能力)。但是在强大的控制力和不被外界的控制影响都无法摆脱原生家庭的问题",
        "3、原生家庭的本身就是家庭成员的彼此能否有探索观察能力明确自己和他人的合理需求，以及有控 制能力对合理的需求予以满足，对自己和他人不合理的需求的管理。所有合理需求没有满足以及不 合理的需求强迫满足都是伤害，都会对原生家庭有深刻影响，而这个影响是你只能接受而无法改变 的。好的家庭都是彼此需求都被妥善的管理和满足着，自己的阶层定位都很明确，一直如何日月星 城一般的保持的很好。",
        "4、最终满足别人的能力，管理自己需求的能力，探索自己和他人需求的能力，都只能通过教育来实 现，通过训练提高，需要努力抓住机会，不断努力赢得别人的信任(让别人来满足自己的需求)来 实现",
        "5、商业社会的本质是为他人创造价值而得到收益，所以更好的满足别人就是实现自己最大价值的过 程，当然，这个过程包括着很多苦难，很难避免伤害。这也是老子说:老死不相往来的原油，只是 老子在解决问题上更加消极，而我们更应该采用水火既济，尔不是水火未济的态度",
        "本篇的三部曲已经基本完成，探索过程思考过程经历了3-4年的时间，研究了易经，先秦文学，古老 的四书五经，等等，这里我特别的说明，比如易经，老子，尚书这样的古典文学中都对上面的问题 做了正面的解释，但是碍于古代成书的意图，书中不能直接明白的回答问题。今天的书籍是为了传 播，而古代的书籍是为了思考，所以大部分都要求背诵，并配有说文解字的过程，我很希望这种用 文字解释文字的方式复兴，也很喜欢是语录体的方式来记录书籍，因为这可以引发你深刻的思考。",
        "之所以写三部曲，我发现这是每个人一生中必须经历的事情，从理解关系到使用法律保护关系，从教育学习让自己能控制自己，变的自律有责任心，诚实，勤奋，懂得为别人创造价值，从原生家庭的⻆度看到每个人的人品和社会道德的差距以及改善目标对社会的价值意义。",
        "洞观三部曲，最终发现比较有操作实践可能的就是第二篇，心理和教育，这是唯一能推动人主动的过程，而这个过程，就是勤劳的过程，或者说勤奋探索，勤奋思考。从训练上来说，辛勤劳动是有助于人探索和思考的，但是􏰀复的劳动往往效率都低，这还是需要再平衡的过程。而解决问题往往需要很多训练，􏰀复的训练往往效率也低，因为很多时候并不⻅得会碰到问题，所以对于环境相当稳定，没有逆境的人来，一生即便努力，也可能是平庸的。很多问题并非人力而为，是时代本身的问题，但是人还必须努力，正如冯友兰在《中国哲学简史》里说的:人要先说很多话，然后保持沉默。有些东⻄得到了就要拼命珍惜，因为丢掉的时候你还要拼命争取，比如信任。",
        ]
}
/*
story1Module[9] = {
...
module.exports = { story1Module: story1Module }