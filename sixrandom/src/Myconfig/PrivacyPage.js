...
class PrivacyPage extends React.Component {
  ...
  render() {
    ...
    Privacyment.push("")
    Privacyment.push("1. 北京月昱科技有限公司尊重并保护所有使用服务用户的个人隐私权。为了给您提供更准确、更有个性化的服务，北京月昱科技有限公司会按照本隐私权政策的规定使用和披露您的个人信息。但北京月昱科技有限公司将以高度的勤勉、审慎义务对待这些信息。除本隐私权政策另有规定外，在未征得您事先许可的情况下 ，北京月昱科技有限公司不会将这些信息对外披露或向第三方提供。北京月昱科技有限公司会不时更新本隐私权政策 。 您在同意北京月昱科技有限公司服务使用协议之时，即视为您已经同意本隐私权政策全部内容。本隐私 权政策属于北京月昱科技有限公司服务使用协议不可分割的一部分。")
    ...
    Privacyment.push("c) 为服务用户的目的，北京月昱科技有限公司可能通过使用您的个人信息，向您提供您感兴趣的信息，包括但不限于向您发出产品和服务信息，或者与北京月昱科技有限公司合作伙伴共享信息以便他们向您发送 有关其产品和服务的信息（后者需要您的事先同意）。")
    ...
    Privacyment.push("a) 乾坤爻原作者范小龙，版本归属北京月昱科技有限公司")
