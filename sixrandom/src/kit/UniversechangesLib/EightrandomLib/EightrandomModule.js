...
class EightrandomModule extends React.Component {
    ...
    parentday(other, self) {
        ...
        map['甲'] = ['比肩', '劫财', '食神', '伤官', '正财', '偏财', '七杀', '正官', '枭印', '正印']
        map['乙'] = ['劫财', '比肩', '伤官', '食神', '偏财', '正财', '正官', '七杀', '正印', '枭印']
        map['丙'] = ['枭印', '正印', '比肩', '劫财', '食神', '伤官', '正财', '偏财', '七杀', '正官']
        map['丁'] = ['正印', '枭印', '劫财', '比肩', '伤官', '食神', '偏财', '正财', '正官', '七杀']
        map['戊'] = ['七杀', '正官', '枭印', '正印', '比肩', '劫财', '食神', '伤官', '正财', '偏财']
        map['己'] = ['正官', '七杀', '正印', '枭印', '劫财', '比肩', '伤官', '食神', '偏财', '正财']
        map['庚'] = ['正财', '偏财', '七杀', '正官', '枭印', '正印', '比肩', '劫财', '食神', '伤官']
        map['辛'] = ['偏财', '正财', '正官', '七杀', '正印', '枭印', '劫财', '比肩', '伤官', '食神']
        map['壬'] = ['食神', '伤官', '正财', '偏财', '七杀', '正官', '枭印', '正印', '比肩', '劫财']
        map['癸'] = ['伤官', '食神', '偏财', '正财', '正官', '七杀', '正印', '枭印', '劫财', '比肩']
    ...
    parentearth(other, self) {
        ...
        map['子'] = ['枭印', '正印', '七杀', '正官', '正财', '偏财', '食神', '伤官', '比肩', '劫财']
        map['丑'] = ['偏财', '正财', '伤官', '食神', '劫财', '比肩', '正印', '枭印', '正官', '七杀']
        map['寅'] = ['比肩', '劫财', '枭印', '正印', '七杀', '正官', '正财', '偏财', '食神', '伤官']
        map['卯'] = ['劫财', '比肩', '正印', '枭印', '正官', '七杀', '偏财', '正财', '伤官', '食神']
        map['辰'] = ['正财', '偏财', '食神', '伤官', '比肩', '劫财', '枭印', '正印', '七杀', '正官']
        map['巳'] = ['伤官', '食神', '劫财', '比肩', '正印', '枭印', '正官', '七杀', '偏财', '正财']
        map['午'] = ['食神', '伤官', '比肩', '劫财', '枭印', '正印', '七杀', '正官', '正财', '偏财']
        map['未'] = ['偏财', '正财', '伤官', '食神', '劫财', '比肩', '正印', '枭印', '正官', '七杀']
        map['申'] = ['七杀', '正官', '正财', '偏财', '食神', '伤官', '比肩', '劫财', '枭印', '正印']
        map['酉'] = ['正官', '七杀', '偏财', '正财', '伤官', '食神', '劫财', '比肩', '正印', '枭印']
        map['戌'] = ['正财', '偏财', '食神', '伤官', '比肩', '劫财', '枭印', '正印', '七杀', '正官']
        map['亥'] = ['正印', '枭印', '正官', '七杀', '偏财', '正财', '伤官', '食神', '劫财', '比肩']
    ...
    /* map['甲寅'] = */ map['乙丑'] = map['丙子']  /* = map['丁酉'] */ /* = map['戊申'] */ /* = map['己未'] */ = map['庚午'] = map['辛巳'] = map['壬辰'] /* = map['癸卯'] */ = '福星 '
        ...
        map['甲午'] /* =map['乙午'] */ = map['丙寅'] /* = map['丁未'] */ = map['戊辰'] = map['己辰'] /* = map['庚戌']  =map['辛酉'] */ = map['壬子'] = map['申子'] = '红艳(年) '
        map['甲申'] /* =map['乙申'] */ = '红艳(年) '
