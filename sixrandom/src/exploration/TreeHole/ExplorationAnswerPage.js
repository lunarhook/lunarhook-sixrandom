...
import {StyleSheet,View,Button, TouchableOpacity,Dimensions, Text,RefreshControl,ScrollView} from 'react-native';
...
class ExplorationAnswerPage extends React.Component<any, any> {
  ...
  static navigationOptions = ({navigation})=>{
    ...
    title: RouteConfig["ExplorationAnswerPage"].name,
    }
  };
  NewQuora() 
  {
  ...
  render()
  {
    ...
    return (
      ...
      <ScrollView>
        <TextareaItem rows={10} placeholder="提出您的咨询问题" count={2000} />
        <List>
        <WhiteSpace size="xl" />
          <List.Item
            extra={
...
module.exports=ExplorationAnswerPage;  