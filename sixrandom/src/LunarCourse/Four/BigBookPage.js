          ...
          return (
            ...
            >
              ...
              >
                  ...
                  <Text style={{fontSize:FontStyleConfig.getFontApplySize()+22}}>{ constBig[index].name}</Text>
        ...
        return (
          ...
          >
            ...
            <Button
                ...
                >
                   <Text style={{fontSize:FontStyleConfig.getFontApplySize()+18}}>{constBig[index].name  }{index==this.state.keyindex?IconConfig.IconStar:""}</Text>
                </Button>
          </List.Item>
        );
      });
