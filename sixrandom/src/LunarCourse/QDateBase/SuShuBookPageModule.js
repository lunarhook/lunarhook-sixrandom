...
var SuShuBookPageModule = new Array()



SuShuBookPageModule[0] = {"index":"素书","name":"道德经",
"content":["　　《素书》相传为秦末黄石公作。民间视为奇书、天书。《素书》以道家思想为宗旨，集儒、法、兵的思想发挥道的作用及功能，同时以道、德、仁、义、礼为立身治国的根本、揆度宇宙万物自然运化的理数，以此认识事物，对应事物、处理事物的智能之作。传说黄石公三试张良，而后把此书授予张良。张良凭借此书，助刘邦定江山。"
],
}

SuShuBookPageModule[1]={
"index":"素书",
"name":"原始",
"content":[
    "　　夫道、德、仁、义、礼五者，一体也。",
...
module.exports={SuShuBookPageModule:SuShuBookPageModule}