...
var ErYaBookModule = new Array()
ErYaBookModule[0] = new Array()
ErYaBookModule[0] = {
    "name":"尔雅",
    "key":"目录",
    "content":["《尔雅》全书收词语4300多个，分为2091个条目。本20篇，现存19篇。它大约是秦汉间的学者缀缉先秦各地的诸书旧文，递相增益而成的。这些条目按类别分为“释诂”、“释言”、“释训”、“释亲”、“释宫”、“释器”、“释乐（yuè）”、“释天”、“释地”、“释丘”、“释山”、“释水”、“释草”、“释木”、“释虫”、“释鱼”、“释鸟”、“释兽”、“释畜（chù）”等19篇。",
...
ErYaBookModule[1] = {
    ...
    "如、适、之、嫁、徂、逝，往也。",
    "赉、贡、锡、畀、予、贶，赐也。",
    "仪、若、祥、淑、鲜、省、臧、嘉、令、类、綝、彀、攻、谷、介、徽，善也。",
    "舒、业、顺，叙也。舒、业、顺、叙，绪也。",
    "怡、怿、悦、欣、衎、喜、愉、豫、恺、康、妉、般，乐也。",
    "悦、怿、愉、释、宾、协，服也。",
    "遹、遵、率、循、由、从，自也。遹、遵、率、循也。",
...
"流、差、柬，择也。",
"战、栗、震、惊、戁、竦、恐、慴，惧也。",
"痡、瘏、虺颓、玄黄、劬劳、咎、顇、瘽、瘉、鳏、戮、癙、癵、悝、痒、疷、疵、闵、逐、疚、痗、瘥、痱、瘅、瘵、瘼、癠，病也。",
"恙、写、悝、盱、繇、惨、恤、罹，忧也。",
"伦、勚、邛、敕、勤、愉、庸、瘅，劳也。",
"劳、来、强、事、谓、剪、篲，勤也。",
"悠、伤、忧，思也。",
...
ErYaBookModule[5] = {
    ...
    "key":"第五",
    "content":[
        "《尔雅·释宫》，是《尔雅》的第五篇。《尔雅·释宫》的篇目内涵体现了古人对“宫”的独特定义，其词条释义又展现了古人设置室内所注意的祭祀、养生、光线等问题，但这些释义中仍有一些矛盾之处。《释宫》所释之词的精细程度及其对宫室规模的要求体现了此篇诠释的对象应是王侯居所，其君本位思想和礼仪规范也在这些释义中得以强调。",
"宫谓之室，室谓之宫。",
"牖户之间谓之扆，其内谓之家。",
"东西墙谓之序。",
"西南隅谓之奥，西北隅谓之屋漏，东北隅谓之宧，东南隅谓之窔。",
"柣谓之阈，枨谓之楔，楣谓之梁。",
"枢谓之椳。",
"枢达北方谓之落时，落时谓之戺。",
"垝谓之坫，墙谓之墉。",
...
ErYaBookModule[7] = {
    "name":"尔雅·释乐",
    "key":"第七",
    "content":["宫谓之重，商谓之敏，角谓之经，徵谓之迭，羽谓之柳。",
    "大瑟谓之洒。",
    "大琴谓之离。",
    "大鼓谓之鼖，小者谓之应。",
    "大磬谓之毊。",
...
ErYaBookModule[8] = {
    ...
    "祭名",
    "春祭曰祠，夏祭曰礿，秋祭曰尝，冬祭曰烝。",
    "祭天曰燔柴，祭地曰瘗埋。祭山曰庪县，祭川曰浮沈，祭星曰布，祭风曰磔。",
    "『是禷是禡』，师祭也。",
    "『既伯既祷』，马祭也。",
    "禘，大祭也。",
    "绎，又祭也。周曰绎，商曰肜，夏曰复胙。",
...
ErYaBookModule[9] = {
    ...
    "五方",
    "东方有比目鱼焉，不比不行，其名谓之鲽；南方有比翼鸟焉，不比不飞，其名谓之鹣鹣；西方有比肩兽焉，与邛邛岠虚比，为邛邛岠虚啮甘草，即有难，邛邛岠虚负而走，其名谓之蹷；北方有比肩民焉，迭食而迭望；中有枳首蛇焉。此四方中国之异气也。",
    "野",
    "邑外谓之郊，郊外谓之牧，牧外谓之野，野外谓之林，林外谓之坰。",
    "下湿曰隰，大野曰平，广平曰原，高平曰陆，大陆曰阜，大阜曰陵，大陵曰阿。可食者曰原，陂者曰阪，下者曰隰。田一岁曰菑，二岁曰新田，三岁曰畲。",
    "四极",
...
ErYaBookModule[10] = {
    "name":"尔雅·释丘",
    "key":"第十",
    "content":["丘，一成为敦丘，再成为陶丘，再成锐上为融丘，三成为昆仑丘。",
    "如乘者乘丘，如陼者陼丘。",
    "水潦所止，泥丘。方丘，胡丘。",
    "绝高为之京，非人为之丘。",
    "水潦所还，埒丘。上正，章丘。",
...
ErYaBookModule[12] = {
    "name":"尔雅·释水",
    "key":"第十二",
    "content":["滥泉正出。正出，涌出也。沃泉县出。县出，下出也。氿泉穴出，穴出，仄出也。",
    "湀辟，流川。过辨，回川。",
    "灉，反入。潬，沙出。",
    "汧，出不流。归异，出同流，肥。",
    "瀵，大出尾下。",
...
ErYaBookModule[13] = {
    ...
    "薇，垂水。",
    "薜，山麻。",
    "莽，数节。桃枝，四寸有节。粼，坚中。簢，筡中。仲，无笐。，箭萌。篠，箭。",
    "枹，霍首。",
    "素华，轨鬷。",
    "芏，夫王。",
    "藄，月尔。",
