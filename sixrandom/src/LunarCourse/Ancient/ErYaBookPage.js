          ...
          return (
            ...
            >
              ...
              >
                  ...
                  <Text style={{fontSize:FontStyleConfig.getFontApplySize()+22}}>{constErYa[index].key +":"+ constErYa[index].name}</Text>
        ...
        return (
          ...
          >
            ...
            <Button
                ...
                >
                   <Text style={{fontSize:FontStyleConfig.getFontApplySize()+18}}>{constErYa[index].name + constErYa[index].key }{index==this.state.keyindex?IconConfig.IconStar:""}</Text>
                </Button>
          </List.Item>
        );
      });
      ...
      >
        ...
        <WhiteSpace size="xl" />
          ...
          <TabNavigator.Item
            ...
            {
              WechatShare.CourseShareBar(WechatShare,this,RouteConfig["ErYaBookPage"].name)
            }
          </TabNavigator > 
